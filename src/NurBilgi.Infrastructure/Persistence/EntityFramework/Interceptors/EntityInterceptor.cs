...
namespace NurBilgi.Infrastructure.Persistence.EntityFramework.Interceptors;
...
public sealed class EntityInterceptor : SaveChangesInterceptor
{
    ...
    private void UpdateAuditableEntities(DbContext? context)
    {
        ...
        {
            entry.Entity.CreatedByUserId = _currentUserService.UserId.HasValue
        ...
        {
            entry.Entity.ModifiedByUserId = _currentUserService.UserId.HasValue
                ? _currentUserService.UserId.Value.ToString()
                : null;
