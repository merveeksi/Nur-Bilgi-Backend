...
namespace NurBilgi.Infrastructure.Persistence.EntityFramework.Migrations
{
    ...
    [Migration("20250322232346_FixDynamicValues")]
            ...
            modelBuilder.Entity("NurBilgi.Domain.Entities.AiChatMessage", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedOn")
                        ...
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2025, 3, 22, 23, 23, 45, 936, DateTimeKind.Unspecified).AddTicks(3550), new TimeSpan(0, 0, 0, 0, 0)))
            ...
            modelBuilder.Entity("NurBilgi.Domain.Entities.DailyDua", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2025, 3, 22, 23, 23, 45, 993, DateTimeKind.Unspecified).AddTicks(4560), new TimeSpan(0, 0, 0, 0, 0)))
                        .HasColumnName("created_on");
            ...
            modelBuilder.Entity("NurBilgi.Domain.Entities.Note", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2025, 3, 22, 23, 23, 45, 997, DateTimeKind.Unspecified).AddTicks(7150), new TimeSpan(0, 0, 0, 0, 0)))
                        .HasColumnName("created_on");
